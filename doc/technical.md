...
- 游戏：Past Life
- 类型：social
- 简述：A candlelit medium reads your face and recalls the life your soul lived before this one — your name, your trade, your city, and how you died — then paints the period portrait. AlterU After Dark.
...
- 平台元信息：meta.title=Past Life；cover_url=/poster.png；category=social；uuid=acbf5a8d-763d-42e1-aa2f-93e659d77da3
...
- `src/PastLife/types.ts`
- `src/PastLife/PastLife.less`
- `src/PastLife/PastLife.tsx`
- `src/PastLife/index.ts`
- `src/PastLife/utils/audio.ts`
- `src/PastLife/utils/prompts.ts`
- `src/PastLife/utils/booking.ts`
