...
Past Life 是一个 `social` 类型的移动端小游戏：A candlelit medium reads your face and recalls the life your soul lived before this one — your name, your trade, your city, and how you died — then paints the period portrait. AlterU After Dark.

## 2. Visual Design

- 整体布局：页面占用 100vw x 100vh，主体验居中，HUD 与操作区覆盖在游戏层上方，移动端以单手操作为优先。
- 背景与配色：主要颜色使用 rgba(0, 0, 0, 0.5)、rgba(0, 0, 0, 0.6)、#060403、rgba(0, 0, 0, 0.4)、rgba(0, 0, 0, 0.9)、rgba(0, 0, 0, 0.55)、rgba(231, 200, 126, 0.5)、rgba(255, 255, 255, 0.35)；高亮元素用于可点击目标、得分、结果或稀有状态。
- 字体：使用 'Special Elite', 'IBM Plex Mono', ui-monospace, SFMono-Regular, Menlo, monospace、@serif、@mono、@sc，按钮与状态文字保持 12-24 px 的可读范围。
...
- 美术素材清单：
- poster_art.png：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- demo_portrait.jpg：位图图片，用于角色、场景、封面、反馈或品牌视觉。
- hero.jpg：位图图片，用于角色、场景、封面、反馈或品牌视觉。
